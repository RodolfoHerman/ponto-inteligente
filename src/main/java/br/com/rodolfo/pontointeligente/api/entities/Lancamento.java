...
public class Lancamento implements Serializable {
    ...
    public String toString() {
        return String.format("Lancamento [id = %d, data = %ta, descricao = %s, localizacao = %s, dataCriacao = %ta, dataAtualizacao = %ta, tipo = %s, funcionario = %s]", id, data, descricao, localizacao, dataCriacao, dataAtualizacao, tipo.toString(), funcionario);
    }
